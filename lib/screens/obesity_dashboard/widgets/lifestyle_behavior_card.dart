...
class LifestylebehaviorCard extends StatefulWidget {
  final String title;
  final String value;
  ...
  @override
  State<LifestylebehaviorCard> createState() => _LifestyleFactorCardState();
}

class _LifestyleFactorCardState extends State<LifestylebehaviorCard> {
